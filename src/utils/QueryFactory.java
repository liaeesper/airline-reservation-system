...
public class QueryFactory {
	...
	public static String getsomeFlights(String teamName, String airport, String thedate) {
		return "?team=" + teamName + "&action=list&list_type=departing&airport=" + airport + "&day=" + thedate;
	}
